	...
	namespace NativeGraphics {
		...
		class SwapChain final {
			...
			inline SwapChain& set_buffer_usage(BufferUsage usage = MACHI_USAGE_RENDER_TARGET_OUTPUT) {
				...
				switch (usage)
				{
				case MACHI_CPU_ACCESS_NONE:
					break;
				case MACHI_CPU_ACCESS_DYNAMIC:
					break;
				case MACHI_CPU_ACCESS_READ_WRITE:
					break;
				case MACHI_CPU_ACCESS_SCRATCH:
					break;
				case MACHI_CPU_ACCESS_FIELD:
					break;
				case MACHI_USAGE_SHADER_INPUT:
					break;
				case MACHI_USAGE_RENDER_TARGET_OUTPUT:
					m_swapchain_desc.BufferUsage = DXGI_USAGE_RENDER_TARGET_OUTPUT;
					break;
				case MACHI_USAGE_BACK_BUFFER:
					break;
				case MACHI_USAGE_SHARED:
					break;
				case MACHI_USAGE_READ_ONLY:
					break;
				case MACHI_USAGE_DISCARD_ON_PRESENT:
					break;
				case MACHI_USAGE_UNORDERED_ACCESS:
					break;
				default:
					break;
				}
			...
			inline MUINT get_frame_count() { return m_swapchain_desc.BufferCount; };
